...
abstract class TableModel
{
    ...
    {
        return new PDO("mysql:host=localhost;dbname=tindew;charset=utf8", "root", "troiswa");
    }
    ...
    public function find($whereValue, string $whereColumn = "id", bool $multipleReturns = false)
    {
